...
@section('content')
<div class="container">
	@include('administrar.clientes.modal')
...
<div class="col-md-9 mx-auto">
	...
	?>
	<form action="{{route('clientes.store', $arrDomi['key'] )}}" method="POST">
	    ...
	    <table class="table table-borderless">
		    ...
		    <br>
		    <a href="{{url('administrar/clientes')}}" class="btn btn-warning float-left" role="button">Atrás</a>
