          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1 style="color: rgba(255,192,21);font-size: 24px;font-weight: 700;font-family: 'Lato', sans-serif;">Bienvenido {{$Nombre}} {{$Apellido}}</h1>
			         </td>
          		</tr>
          	</table>
          </td>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				...
            				<h4 style="text-align: justify; color: black;">Queremos darte la bienvenida a <b>TusComprasHoy</b>, gracias por registrarte! tu usuario ha sido activado exitosamente y ahora formas parte de nuestro gran equipo.</h4>
            				<p><a style="padding: 10px 15px;
        	display: inline-block; border-radius: 5px;
        	background: rgba(255,192,21);
        	color: #ffffff;" href="http://tuscomprashoy.com/">Visítanos en nuestra página web</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
