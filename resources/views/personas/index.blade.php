...
<div class="container">
    ...
    <br>
    <h2>Listado De Clientes Registrados <a href="personas/create"><button type="button" class="btn btn-success float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Agregar Cliente</button></a></h2> <br>
    <h6>
